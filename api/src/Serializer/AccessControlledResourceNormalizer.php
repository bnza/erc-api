...
final class AccessControlledResourceNormalizer implements NormalizerInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $object, string $format = null, array $context = [])
    {
        ...
        if (is_array($data)) {
            $data['canRead'] = $this->security->isGranted('read', $object);
            $data['canUpdate'] = $this->security->isGranted('update', $object);
            $data['canDelete'] = $this->security->isGranted('delete', $object);
        }
