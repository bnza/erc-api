...
final class Version20240712143020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE su (id INT NOT NULL, site_id INT NOT NULL, area_id INT DEFAULT NULL, number INT NOT NULL, year INT NOT NULL, description TEXT DEFAULT NULL, interpretation TEXT DEFAULT NULL, public BOOLEAN DEFAULT false NOT NULL, PRIMARY KEY(id))'
        );
